...
type
  ...
  public
    constructor Create(Name: ShortString; List: TsgeStringList; DefValue: Word; Getter: TsgeVariableEnumClassGetter; Setter: TsgeVariableEnumClassSetter);
...
constructor TsgeVariableEnumClass.Create(Name: ShortString; List: TsgeStringList; DefValue: Word; Getter: TsgeVariableEnumClassGetter; Setter: TsgeVariableEnumClassSetter);
begin
