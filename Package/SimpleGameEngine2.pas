...
uses
  ...
  sgeGraphicElementLayerList, sgeGraphicElementList, sgeGraphicElementLine, 
  sgeGraphicElementRectangleGradient, sgeGraphicElementSprite, 
  sgeGraphicElementSpritePart, sgeGraphicElementSpriteTile, 
  sgeGraphicElementText, sgeGraphicFont, sgeGraphicFPS, sgeGraphicSprite, 
  sgeGraphicSpriteGDIPLoader, sgeGraphicSpriteLoader, sgeGraphicUtils, 
  sgeScreenFade, sgePackFileList, sgePackFileReader, sgePackFileWriter, 
  sgeSoundBuffer, sgeSoundBufferLoader, sgeSoundBufferWavLoader, 
  sgeSoundSource, sgeTemplateCollection, sgeTemplateThreadSafeList, 
  sgeSystemCursor, sgeSystemIcon, sgeSystemTimeEvent, sgeSystemTrayIcon, 
  sgeVariableBooleanNormal, sgeVariableBooleanBase, sgeVariableBooleanProc, 
  sgeVariableIntegerNormal, sgeVariableIntegerBase, sgeVariableIntegerProc, 
  sgeVariableList, sgeVariableSingleNormal, sgeVariableSingleBase, 
  sgeVariableSingleProc, sgeVariableColorNormal, sgeVariableColorBase, 
  sgeVariableColorProc, sgeTemplateThreadSafeCollection, 
  ...
  sgeGraphicColorUtils, sgeGraphicElementRectangle;
