...
constructor TsgeShellCommandParameterInteger.Create(Name: ShortString; Required: Boolean; PrefixRequired: Boolean; PrefixList: String; Separator: String);
begin
  inherited Create(scptInteger, Name, Required, PrefixRequired, PrefixList, Separator);
end;
