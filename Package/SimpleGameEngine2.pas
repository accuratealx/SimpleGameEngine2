...
uses
  ...
  sgeGraphicAnimationFrames, sgeGraphicColor, sgeGraphicDrawList, 
  ...
  sgeShellCommand_System_Read, sgeShellCommand, sgeShellCommandList, 
  sgeCommandHistory, sgeSystemConsole, sgeExtensionKeyCommand, 
  sgeShellCommandQueue, sgeKeyCommandKeyboard, sgeKeyCommandMouse, 
  sgeKeyCommandJoystick, sgeKeyCommandJoystickButtonInfo, 
