...
uses
  ...
  sgeSpriteLoaderGDIP, sgeDisplayElementAnimation, sgeDisplayElementAnsiText, 
  ...
  sgeDisplayElementSpriteTile, sgeGraphicOpenGLBuffer, 
  sgeGraphicOpenGLCoordBuffer, sgeGraphicOpenGLShader, 
